...
for file in "${CRITICAL_FILES[@]}"; do
  if [ -f "/home/louis/scholar-flow/$file" ]; then
    echo "   ✅ $file exists"
  else
    echo "   ❌ $file missing"
    exit 1
...
# 检查编辑API路由
if grep -q "@router.get.*pipeline" "/home/louis/scholar-flow/backend/app/api/v1/editor.py"; then
...
if grep -q "@router.get.*available-reviewers" "/home/louis/scholar-flow/backend/app/api/v1/editor.py"; then
...
if grep -q "@router.post.*decision" "/home/louis/scholar-flow/backend/app/api/v1/editor.py"; then
...
# 检查EditorDashboard组件
if grep -q "EditorPipeline" "/home/louis/scholar-flow/frontend/src/components/EditorDashboard.tsx"; then
...
if grep -q "ReviewerAssignModal" "/home/louis/scholar-flow/frontend/src/components/EditorDashboard.tsx"; then
...
if grep -q "DecisionPanel" "/home/louis/scholar-flow/frontend/src/components/EditorDashboard.tsx"; then
...
if grep -q "EditorDashboard" "/home/louis/scholar-flow/frontend/src/app/dashboard/page.tsx"; then
...
if grep -q "value=\"editor\"" "/home/louis/scholar-flow/frontend/src/app/dashboard/page.tsx"; then
...
# 检查Tabs组件
if grep -q "TabsPrimitive" "/home/louis/scholar-flow/frontend/src/components/ui/tabs.tsx"; then
...
# 检查utils
if grep -q "cn" "/home/louis/scholar-flow/frontend/src/lib/utils.ts"; then
