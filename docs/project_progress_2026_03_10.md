...
**图示说明**：下文状态机图与流程图基于当前已落代码、测试与上线约束整理，不是理想化愿景图。
...
![审稿组织流程](project_progress_editorial_flow_2026_03_10.svg)

## 9. 图 4：外审退出与决策流转

![外审退出与决策流转](project_progress_decision_flow_2026_03_10.svg)
