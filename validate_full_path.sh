...
# 检查HeroSection中的搜索功能
if grep -q "handleSearch" "/home/louis/scholar-flow/frontend/src/components/home/HeroSection.tsx"; then
...
# 检查搜索页中的链接
if grep -q "/articles/" "/home/louis/scholar-flow/frontend/src/app/search/page.tsx"; then
...
# 检查文章页中的下载功能
if grep -q "handleDownload" "/home/louis/scholar-flow/frontend/src/app/articles/[id]/page.tsx"; then
...
# 检查搜索API
if grep -q "@router.get.*search" "/home/louis/scholar-flow/backend/app/api/v1/manuscripts.py"; then
...
# 检查下载统计API
if grep -q "@router.post.*download" "/home/louis/scholar-flow/backend/app/api/v1/stats.py"; then
...
# 检查文章详情API
if grep -q "@router.get.*articles" "/home/louis/scholar-flow/backend/app/api/v1/manuscripts.py"; then
...
# 检查SEO配置
if grep -q "openGraph" "/home/louis/scholar-flow/frontend/src/app/layout.tsx"; then
...
if grep -q "twitter:" "/home/louis/scholar-flow/frontend/src/app/layout.tsx"; then
