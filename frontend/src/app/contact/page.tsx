        ...
        <section className="mx-auto max-w-5xl px-4 py-12 sm:px-6 lg:px-8">
          <div className="grid gap-4 md:grid-cols-3">
            <article className="rounded-2xl border border-slate-200 bg-white p-5">
              ...
              <p className="mt-2 text-sm text-slate-600">editorial@scholarflow.org</p>
            </article>
            ...
            <article className="rounded-2xl border border-slate-200 bg-white p-5">
              ...
              <p className="mt-2 text-sm text-slate-600">+1 (555) 102-2048</p>
            </article>
            ...
            <article className="rounded-2xl border border-slate-200 bg-white p-5">
              ...
              <p className="mt-2 text-sm text-slate-600">Global Research Hub, Academic District</p>
            </article>
          </div>

          <div className="mt-8 rounded-2xl border border-slate-200 bg-white p-6">
            <h3 className="text-xl font-serif font-semibold text-slate-900">Need quick help?</h3>
            ...
            <div className="mt-5 flex flex-wrap gap-3">
              <a
                ...
                className="inline-flex items-center gap-2 rounded-full bg-blue-600 px-5 py-2.5 text-sm font-semibold text-white hover:bg-blue-500"
              >
              ...
              <Link
                ...
                className="inline-flex items-center rounded-full border border-slate-200 bg-white px-5 py-2.5 text-sm font-semibold text-slate-900 hover:bg-slate-50"
              >
                CMS Contact Page
              </Link>
            </div>
