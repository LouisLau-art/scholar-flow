...
describe('Reviewer summary cards', () => {
  ...
  it('renders reviewer management table with outreach actions', () => {
    ...
    expect(screen.getByText(/Reminded: /i)).toBeInTheDocument()
    expect(screen.getByText(/Invited by Inviter User/i)).toBeInTheDocument()
    expect(screen.queryByText(/Selected by Selector User via Editor shortlist/i)).not.toBeInTheDocument()
    expect(screen.queryByText(/Invited by Inviter User via Invitation template/i)).not.toBeInTheDocument()
    expect(screen.queryByText(/Invitation sent by Inviter User to reviewer@example.com/i)).not.toBeInTheDocument()
