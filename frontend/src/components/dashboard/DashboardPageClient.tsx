...
function DashboardPageContent({
  ...
  useEffect(() => {
    if (initialStatsLoaded && initialSubmissionsLoaded && initialRolesLoaded) {
      return
    }
  ...
  }, [initialRolesLoaded, initialStatsLoaded, initialSubmissionsLoaded])
