  ...
  return (
    <section className="space-y-4" data-testid="coverage-dashboard">
      <div className="flex items-center justify-between">
        <h2 className="text-lg font-semibold text-slate-900">测试覆盖率</h2>
        <span className="text-sm text-slate-500">总体状态：{formatStatus(thresholds?.overall_ok)}</span>
      </div>

      <div className="grid gap-4 md:grid-cols-2">
        <div className="rounded-xl border border-slate-200 bg-white p-4 shadow-sm" data-testid="coverage-backend">
          <h3 className="text-sm font-semibold text-slate-700">后端覆盖率</h3>
        ...
        <div className="rounded-xl border border-slate-200 bg-white p-4 shadow-sm" data-testid="coverage-frontend">
          <h3 className="text-sm font-semibold text-slate-700">前端覆盖率</h3>
          <div className="mt-3 space-y-1 text-sm text-slate-600">
