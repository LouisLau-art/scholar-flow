    ...
    *,
    ...
    if isinstance(raw_contacts, list):
        for item in raw_contacts:
            ...
            if email == submission_email and normalized.get("name"):
                submission_contact_name = str(normalized["name"]).strip()
    ...
    target["recipient_name"] = submission_contact_name or str(target.get("recipient_name") or "").strip() or _titleize_email_local_part(submission_email)
