...
class EmailTemplateCreateRequest(BaseModel):
    ...
    event_type: Literal["none", "invitation", "reminder", "cancellation", "first_decision_request"] = "none"
...
class EmailTemplateUpdateRequest(BaseModel):
    ...
    event_type: Optional[Literal["none", "invitation", "reminder", "cancellation", "first_decision_request"]] = None
